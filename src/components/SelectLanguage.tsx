export default function SelectLanguage({
	...
	return (
		<div
			className={`cursor-pointer rounded-[4px] border-[1px] border-[#5f5e5e] ${className}`}
		>
			<div
			...
			>
				...
				<select
					className={`relative flex cursor-pointer flex-col bg-transparent py-1 sm:text-black dark:sm:text-white ${
						shrink
							? "text-transparent sm:px-8 [&>option]:text-black"
							: "px-8 text-black dark:text-white"
					}`}
				>
